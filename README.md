...
## Other Fyio / Kolay projects

Built by the same team — same design philosophy (typed, batteries-included,
zero-config-where-it-matters):

| Project | What it does |
|---|---|
| 🌐 **[Kolaybase](https://kolaybase.com)** | Postgres-as-a-service. One-click setup, branch databases, point-in-time recovery, generous free tier. The DB behind Payfyio Cloud itself. |
| 🔐 **[Kolaylogin](https://kolaylogin.com)** | Drop-in authentication for Next.js / Node — email/password, OAuth (GitHub, Google), magic links, sessions. |
| ☁️ **[@fyio/payfyio-cloud](https://www.npmjs.com/package/@fyio/payfyio-cloud)** | Typed SDK for the Payfyio Cloud dashboard API — manage projects, credentials, members, payments programmatically. |

More to come — follow [@payfyio](https://twitter.com/payfyio) for releases.
